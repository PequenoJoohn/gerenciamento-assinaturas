...
class SubscriptionService:
    ...
    def gen_chart(self):
        ...
        # Converte o resultado de map para uma lista
...
# subscription = Subscription(empresa='netflix', site='netflix.com.br', data_assinatura=date.today(), valor=12)
# ss.create(subscription)
# print(ss.pay(subscription))
